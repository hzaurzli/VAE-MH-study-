...
sample_frac=0.2
log_results=True 
Result_root='results/test/'
debug=True

### resume training setup ###l
resume_train= False
training_info_folder='results/test'
resume_model_path=training_info_folder+'/models/'+ 'train_model_100.ckpt'#'train_model_cont.ckpt'
...
dataset_params={
'data_path':'../data_processing/my_data/unlabeled_new_2.csv',
'max_seq_len': 7, #7,  ###  max extension length
'condition_length': 15,#15, ### conditional peptide length 
'max_peptide_length':22, ###  max length of the peptide 
