...
# peptide_all_converted.to_csv("peptide_all_converted.csv")
# sys.exit(0)
...
# valid_df_satpdb.to_csv('test.csv')
# sys.exit(0)



# print ('df',df['seq'])
# print ('valid_df_satpdb',valid_df_satpdb['seq'])
# df_overlap = pd.merge(df, valid_df_satpdb, on='seq', how='inner')
# print ('df_overlap',df_overlap)
# print (df.merge(valid_df_satpdb, on='seq', how='inner'))
# sys.exit(0)
...
# print ('df_overlap before',df_overlap)
df_overlap = get_seq_len_less_than(df_overlap, 50)
# print ('df_overlap after',df_overlap)
# sys.exit(0)
...
# print (ampep_pos.ampep)
ampep_pos = ampep_pos.drop(columns=['label'])
# print (ampep_pos.seq)
# ampep_pos.to_csv('test.csv')
# sys.exit(0)
...
# print (dbaasp_pos)
# dbaasp_pos.to_csv('test.csv')

# print (dbaasp_pos1)
# dbaasp_pos1.to_csv('test.csv')
...
# amp_pos.to_csv('test.csv')
# sys.exit(0)

#### Tong: changed ####
# amp_pos['source'] = amp_pos['source'].map({'dbaasp_pos': 'amp_pos', 'ampep_pos': 'amp_pos', 'satpdb_pos': 'amp_pos'})
amp_pos['source'] = amp_pos['source'].map({'dbaasp_pos': 'amp_posc', 'ampep_pos': 'amp_posnc', 'satpdb_pos': 'amp_posc'})
#### ends ####
...
# toxic = valid_df_satpdb[valid_df_satpdb['Major.Functions'].str.contains("toxic")] ### Tong: this line is not needed 
...
#### Tong: dont use overlap ####
df_overlap_tox=df

#### ends ####

# print (df_overlap_tox)
# sys.exit(0)
...
# amp_pos.to_csv('test.csv')
# amp_pos.to_csv('combined_neg1.csv')
# print ('amp_pos',amp_pos)
# print ('amp_pos',combined_neg1)
...
# Solubility dataset creation Tong: no such data set
