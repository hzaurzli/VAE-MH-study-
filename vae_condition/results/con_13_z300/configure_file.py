...
sample_frac=0.2
log_results=True 
Result_root='results/con_13_z300/'
debug=False

### resume training setup ###
resume_train= False
training_info_folder='results/con_15_large'
resume_model_path=training_info_folder+'/models/'+ 'train_model_300.ckpt'#'train_model_cont.ckpt'
...
dataset_params={
'data_path':'../unlabeled_revised_2.csv',
'max_seq_len':13,  ### conditional sequence length 
...
RNN_VAE_params={'n_vocab':len(token),'emb_dim':100,'z_dim':300,'max_seq_len':dataset_params['max_seq_len'],'PAD_IDX':token['pad'],
